...
public class QBoardData extends EntityPathBase<BoardData> {
    ...
    private static final long serialVersionUID = -233944451L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QBoardData boardData = new QBoardData("boardData");

    public final org.kje.global.entities.QBaseEntity _super = new org.kje.global.entities.QBaseEntity(this);
    ...
    public final org.kje.member.entities.QMember member;
    ...
    public QBoardData(Class<? extends BoardData> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new org.kje.member.entities.QMember(forProperty("member")) : null;
    }
